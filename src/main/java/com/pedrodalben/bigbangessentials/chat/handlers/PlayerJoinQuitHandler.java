...
import com.pedrodalben.bigbangessentials.integrations.ChatIntegrationManager;
...
public class PlayerJoinQuitHandler {
    ...
    public static void onPlayerJoin(PlayerEvent.PlayerLoggedInEvent event) {
            ...
            if (config.isNewPlayerKitEnabled()) {
                ...
                if (kitName != null && !kitName.trim().isEmpty()) {
                    ...
                    if (isFirstJoin) {
                        ...
                        com.pedrodalben.bigbangessentials.kits.KitManager kitManager = com.pedrodalben.bigbangessentials.kits.KitManager.getInstance();
                    ...
                    try {
                        ...
                        if (config != null) {
                            com.google.gson.JsonObject mainConfig = config.getConfig(com.pedrodalben.bigbangessentials.config.ConfigManager.MAIN_CONFIG);
                        ...
                        if (isFirstJoin && spawnOnJoin) {
                            com.pedrodalben.bigbangessentials.teleportation.Spawn.SpawnManager.getInstance().teleportToSpawn(player);
                        }
                    } catch (Exception e) {
        ...
        try {
            ...
            try {
                com.pedrodalben.bigbangessentials.util.commands.MailCommand.notifyOnLogin(player);
            } catch (Exception e) {
