...
public class AuthHandler implements HttpHandler {
    ...
    private boolean checkDiscordPermission(String discordId) {
        ...
        com.pedrodalben.bigbangessentials.webdashboard.security.DiscordAuthProvider provider =
            com.pedrodalben.bigbangessentials.webdashboard.security.DiscordAuthProvider.getInstance();
        if (provider.isAvailable()) {
            com.pedrodalben.bigbangessentials.webdashboard.security.DiscordUser discordUser =
