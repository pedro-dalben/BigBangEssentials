...
public class WorthManager {
    ...
    public BigDecimal getSellMultiplier() {
        try {
            com.google.gson.JsonObject cfg = com.pedrodalben.bigbangessentials.config.ConfigManager
                .getInstance().getConfig(com.pedrodalben.bigbangessentials.config.ConfigManager.MAIN_CONFIG);
            if (cfg.has("economy")) {
