...
public class VanishManager {
    ...
    public int getPlayerPriority(UUID playerId) {
        ...
        String group = null;
        try {
            group = com.zerog.bigbangessentials.permissions.PermissionSystem.getManager().getUser(playerId).getGroup();
        } catch (Exception e) {
            // fallback
        }
    ...
    public boolean vanishPlayer(UUID playerId, String playerName, String vanishedBy, boolean selfVanish) {
        ...
        if (com.zerog.bigbangessentials.config.ConfigManager.isLogVanishActionsEnabled()) {
    ...
    boolean hideFromTabList = com.zerog.bigbangessentials.config.ConfigManager.isHideFromTabListEnabled();
