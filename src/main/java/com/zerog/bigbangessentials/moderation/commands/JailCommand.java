...
import com.zerog.bigbangessentials.moderation.JailManager;
...
public class JailCommand {
    ...
    public static void register(CommandDispatcher<CommandSourceStack> dispatcher) {
        ...
        if (!com.zerog.bigbangessentials.config.ConfigManager.isModerationEnabled()
            || !com.zerog.bigbangessentials.moderation.JailManager.isJailSystemEnabled()) {
            return;
        }
        ...
        dispatcher.register(Commands.literal("jail")
            ...
            .then(Commands.argument("player", StringArgumentType.word())
                ...
                .then(Commands.argument("jail", StringArgumentType.word())
                    ...
                    .executes(ctx -> {
                        String defaultReason = com.zerog.bigbangessentials.config.ConfigManager.getInstance()
                            .getConfig("config.json")
                            .has("moderation") && com.zerog.bigbangessentials.config.ConfigManager.getInstance()
                            .getConfig("config.json").getAsJsonObject("moderation")
                            .has("jailSettings") && com.zerog.bigbangessentials.config.ConfigManager.getInstance()
                            .getConfig("config.json").getAsJsonObject("moderation")
            ...
            .then(Commands.argument("player", StringArgumentType.word())
                ...
                .then(Commands.argument("jail", StringArgumentType.word())
                    ...
                    .then(Commands.argument("duration", StringArgumentType.word())
                        .executes(ctx -> {
                            long dur = com.zerog.bigbangessentials.util.commands.MailCommand.parseDuration(
    ...
    private static int executeJail(CommandContext<CommandSourceStack> ctx, String playerName, String jailName, String reason, long durationMillis) {
        ...
        try {
            ...
            boolean requireJailLocation = com.zerog.bigbangessentials.config.ConfigManager.isRequireJailLocationEnabled();
