...
import com.zerog.bigbangessentials.config.ConfigSplitter;
import com.zerog.bigbangessentials.core.ManagerRegistry;
import com.zerog.bigbangessentials.permissions.PermissionSystem;
...
public class BigBangEssentials {
    ...
    private void registerAllManagers() {
        ...
        registry.registerManager("EconomyManager", "economy", 
            com.zerog.bigbangessentials.economy.managers.EconomyManager.class,
            com.zerog.bigbangessentials.economy.managers.EconomyManager::getInstance);
        
        // Chat Managers (only singleton managers)
        registry.registerManager("AfkManager", "chat",
            com.zerog.bigbangessentials.chat.AfkManager.class,
            com.zerog.bigbangessentials.chat.AfkManager::getInstance);
        ...
        registry.registerManager("VanishManager", "moderation",
            com.zerog.bigbangessentials.moderation.VanishManager.class,
            com.zerog.bigbangessentials.moderation.VanishManager::getInstance);
        registry.registerManager("FreezeManager", "moderation",
            com.zerog.bigbangessentials.moderation.FreezeManager.class,
            com.zerog.bigbangessentials.moderation.FreezeManager::getInstance);
        registry.registerManager("JailManager", "moderation",
            com.zerog.bigbangessentials.moderation.JailManager.class,
            com.zerog.bigbangessentials.moderation.JailManager::getInstance);
        
        // Teleportation Managers
        registry.registerManager("HomeManager", "teleportation",
            com.zerog.bigbangessentials.teleportation.HomeManager.class,
            com.zerog.bigbangessentials.teleportation.HomeManager::getInstance);
        registry.registerManager("WarpManager", "teleportation",
            com.zerog.bigbangessentials.teleportation.Warp.WarpManager.class,
        ...
        registry.registerManager("SpawnManager", "teleportation",
            com.zerog.bigbangessentials.teleportation.Spawn.SpawnManager.class,
            com.zerog.bigbangessentials.teleportation.Spawn.SpawnManager::getInstance);
        
        // Kit Managers
        registry.registerManager("KitManager", "kits",
            com.zerog.bigbangessentials.kits.KitManager.class,
            com.zerog.bigbangessentials.kits.KitManager::getInstance);
        
        // Dashboard Managers
        registry.registerManager("AuthenticationManager", "dashboard",
            com.zerog.bigbangessentials.webdashboard.security.AuthenticationManager.class,
            com.zerog.bigbangessentials.webdashboard.security.AuthenticationManager::getInstance);
        
        // API Managers
        registry.registerManager("PlaceholderManager", "api",
            com.zerog.bigbangessentials.api.PlaceholderManager.class,
            com.zerog.bigbangessentials.api.PlaceholderManager::getInstance);
        
        // Configuration Manager
        registry.registerManager("ConfigManager", "core",
            com.zerog.bigbangessentials.config.ConfigManager.class,
            com.zerog.bigbangessentials.config.ConfigManager::getInstance);
        
        // Permission System (special case - initialized in ServerStarting event)
        registry.registerManager("PermissionSystem", "core",
            com.zerog.bigbangessentials.permissions.PermissionSystem.class);
    ...
    public static class GameEvents {
        ...
        public static void onServerStarting(ServerStartingEvent event) {
            ...
            try {
                ...
                com.zerog.bigbangessentials.vault.VaultManager.initialize();
            ...
            try {
                ...
                com.zerog.bigbangessentials.shop.ShopManager.getInstance().initialize();
                LOGGER.info("✓ ChestShop system initialized ({} shop(s) loaded)",
                    com.zerog.bigbangessentials.shop.ShopManager.getInstance().getShopCount());
            } catch (Exception e) {
            ...
            try {
                ...
                com.zerog.bigbangessentials.i18n.CustomLanguageManager.getInstance().initialize();
            ...
            try {
                ...
                com.zerog.bigbangessentials.chat.BadgeManager.getInstance().loadCustomBadgeImages();
            ...
            try {
                ...
                com.zerog.bigbangessentials.resourcepack.ResourcePackManager.getInstance().initialize();
        ...
        public static void onServerStarted(ServerStartedEvent event) {
            ...
            try {
                com.zerog.bigbangessentials.integrations.ChatIntegrationManager.initialize();
            } catch (Exception e) {
            ...
            try {
                com.zerog.bigbangessentials.config.ConfigManager configManager = com.zerog.bigbangessentials.config.ConfigManager.getInstance();
                com.google.gson.JsonObject config = configManager.getConfig(com.zerog.bigbangessentials.config.ConfigManager.MAIN_CONFIG);
                ...
                com.zerog.bigbangessentials.chat.ChatManager chatManager = new com.zerog.bigbangessentials.chat.ChatManager(chatObj, commandsObj);
                com.zerog.bigbangessentials.api.ChatAPI.setChatManager(chatManager);
            ...
            try {
                ...
                com.zerog.bigbangessentials.chat.AfkManager.getInstance().loadConfiguration(afkObj);
            ...
            try {
                com.zerog.bigbangessentials.util.commands.NickCommand.applyNicknamesToOnlinePlayers(event.getServer());
            ...
            try {
                com.zerog.bigbangessentials.tablist.TablistManager.getInstance().loadConfig();
        ...
        public static void onPlayerLoggedIn(net.neoforged.neoforge.event.entity.player.PlayerEvent.PlayerLoggedInEvent event) {
            ...
            if (ConfigSplitter.shouldNotifyAdmins() && event.getEntity() instanceof net.minecraft.server.level.ServerPlayer player) {
                ...
                if (player.hasPermissions(4) ||
                    com.zerog.bigbangessentials.api.permissions.PermissionAPI.hasPermission(player.getUUID(), "*") ||
                    com.zerog.bigbangessentials.api.permissions.PermissionAPI.hasPermission(player.getUUID(), "bigbangessentials.*") ||
                    com.zerog.bigbangessentials.api.permissions.PermissionAPI.hasPermission(player.getUUID(), "bigbangessentials.admin.*")) {
        ...
        public static void onServerStopping(ServerStoppingEvent event) {
            ...
            try {
                ...
                com.zerog.bigbangessentials.economy.managers.EconomyManager.getInstance().shutdown();
            } catch (Exception e) {
            ...
            try {
                ...
                com.zerog.bigbangessentials.economy.managers.TransactionHistoryManager.getInstance().shutdown();
            } catch (Exception e) {
            ...
            try {
                ...
                com.zerog.bigbangessentials.economy.managers.PayToggleManager.getInstance().shutdown();
            } catch (Exception e) {
            ...
            // Shutdown Vault API
            try {
                com.zerog.bigbangessentials.vault.VaultManager.shutdown();
            } catch (Exception e) {
            ...
            try {
                com.zerog.bigbangessentials.shop.ShopManager.getInstance().shutdown();
            } catch (Exception e) {
            ...
            try {
                ...
                com.zerog.bigbangessentials.integrations.ChatIntegrationManager.shutdown();
            } catch (Exception e) {
            ...
            try {
                ...
                com.zerog.bigbangessentials.chat.AfkManager.getInstance().shutdown();
            } catch (Exception e) {
            ...
            try {
                ...
                com.zerog.bigbangessentials.moderation.BanManager.getInstance().shutdownScheduler();
            } catch (Exception e) {
            ...
            try {
                ...
                com.zerog.bigbangessentials.teleportation.TeleportRequests.TeleportRequestManager.getInstance().shutdown();
            } catch (Exception e) {
            ...
            try {
                ...
                com.zerog.bigbangessentials.util.ThreadDiagnostics.logBigBangEssentialsThreads();
                com.zerog.bigbangessentials.util.ThreadDiagnostics.logNonDaemonThreads();
            } catch (Exception e) {
    ...
    private static void registerAllCommands(CommandDispatcher<CommandSourceStack> dispatcher, CommandRegistry registry) {
        ...
        com.zerog.bigbangessentials.commands.ModRootCommand.register(dispatcher);
        ...
        com.zerog.bigbangessentials.commands.teleportation.WarpCommands.register(dispatcher);

        // Register player warp commands if enabled
        if (com.zerog.bigbangessentials.teleportation.Warp.WarpManager.getInstance().isPlayerWarpsEnabled()) {
            ...
            com.zerog.bigbangessentials.commands.teleportation.PwarpCommands.register(dispatcher);
        }
        ...
        com.zerog.bigbangessentials.commands.teleportation.HomeCommands.register(dispatcher);
        ...
        com.zerog.bigbangessentials.commands.teleportation.SpawnCommands.register(dispatcher);
        ...
        com.zerog.bigbangessentials.teleportation.TeleportRequests.TeleportRequestCommands.register(dispatcher);
        ...
        com.zerog.bigbangessentials.teleportation.DirectTeleport.DirectTeleportCommands.register(dispatcher);
        ...
        com.zerog.bigbangessentials.teleportation.Misc.MiscTeleportCommands.register(dispatcher);
        ...
        com.zerog.bigbangessentials.economy.commands.EconomyCommands.register(dispatcher);
        ...
        com.zerog.bigbangessentials.moderation.commands.BanCommand.register(dispatcher);
        com.zerog.bigbangessentials.moderation.commands.KickCommand.register(dispatcher);
        com.zerog.bigbangessentials.moderation.commands.JailCommand.register(dispatcher);
        com.zerog.bigbangessentials.moderation.commands.FreezeCommand.register(dispatcher);
        com.zerog.bigbangessentials.moderation.commands.VanishCommand.register(dispatcher);
        ...
        com.zerog.bigbangessentials.chat.command.MsgCommand.register(dispatcher);
        com.zerog.bigbangessentials.chat.command.ReplyCommand.register(dispatcher);
        com.zerog.bigbangessentials.chat.command.IgnoreCommand.register(dispatcher);
        com.zerog.bigbangessentials.chat.command.UnignoreCommand.register(dispatcher);
        com.zerog.bigbangessentials.chat.command.SocialSpyCommand.register(dispatcher);
        com.zerog.bigbangessentials.chat.command.MuteCommand.register(dispatcher);
        com.zerog.bigbangessentials.chat.command.UnmuteCommand.register(dispatcher);
        com.zerog.bigbangessentials.chat.command.MuteListCommand.register(dispatcher);
        com.zerog.bigbangessentials.chat.command.MsgToggleCommand.register(dispatcher);

        // Register channel commands (dynamically from config)
        com.zerog.bigbangessentials.chat.commands.ChannelCommands.register(dispatcher);

        // ========== LANGUAGE COMMANDS ==========
        registry.registerCommand("language", "Manage custom language files");
        com.zerog.bigbangessentials.commands.LanguageCommand.register(dispatcher);

        // ========== PERMISSIONS COMMANDS ==========
        registry.registerCommand("permissions", "Manage permissions");
        registry.registerCommand("pex", "Manage permissions (alias)");
        com.zerog.bigbangessentials.permissions.command.PermissionsCommand.register(dispatcher);
        ...
        com.zerog.bigbangessentials.kits.command.KitCommands.register(dispatcher);
        ...
        com.zerog.bigbangessentials.inventory.InventoryViewCommands.register(dispatcher);
        com.zerog.bigbangessentials.util.commands.AfkCommand.register(dispatcher);
        com.zerog.bigbangessentials.util.commands.HelpCommand.register(dispatcher);
        com.zerog.bigbangessentials.util.commands.AnvilCommand.register(dispatcher);
        com.zerog.bigbangessentials.util.commands.BookCommand.register(dispatcher);
        com.zerog.bigbangessentials.util.commands.CompassCommand.register(dispatcher);
        com.zerog.bigbangessentials.util.commands.CraftingCommand.register(dispatcher);
        com.zerog.bigbangessentials.util.commands.DepthCommand.register(dispatcher);
        com.zerog.bigbangessentials.util.commands.GetPosCommand.register(dispatcher);
        com.zerog.bigbangessentials.util.commands.GrindstoneCommand.register(dispatcher);
        com.zerog.bigbangessentials.util.commands.HelpopCommand.register(dispatcher);
        com.zerog.bigbangessentials.util.commands.ListCommand.register(dispatcher);
        com.zerog.bigbangessentials.util.commands.MailCommand.register(dispatcher);
        com.zerog.bigbangessentials.util.commands.MotdCommand.register(dispatcher);
        com.zerog.bigbangessentials.util.commands.NearCommand.register(dispatcher);
        com.zerog.bigbangessentials.util.commands.NickCommand.register(dispatcher);
        com.zerog.bigbangessentials.util.commands.PingCommand.register(dispatcher);
        com.zerog.bigbangessentials.util.commands.RealnameCommand.register(dispatcher);
        com.zerog.bigbangessentials.util.commands.RulesCommand.register(dispatcher);
        com.zerog.bigbangessentials.util.commands.SeenCommand.register(dispatcher);
        com.zerog.bigbangessentials.util.commands.SignCommand.register(dispatcher);
        com.zerog.bigbangessentials.util.commands.SmithingCommand.register(dispatcher);
        com.zerog.bigbangessentials.util.commands.StonecuttingCommand.register(dispatcher);
        com.zerog.bigbangessentials.util.commands.SuicideCommand.register(dispatcher);
        com.zerog.bigbangessentials.util.commands.WhoisCommand.register(dispatcher);
        com.zerog.bigbangessentials.util.commands.GamemodeCommand.register(dispatcher);
        
        // ========== WEB DASHBOARD COMMANDS ==========
        registry.registerCommand("dashboard", "Manage web dashboard");
        com.zerog.bigbangessentials.commands.utility.DashboardCommand.register(dispatcher);
        registry.registerCommand("dashboardregister", "Register a dashboard account");
        com.zerog.bigbangessentials.commands.utility.DashboardRegisterCommand.register(dispatcher);
        ...
        com.zerog.bigbangessentials.items.commands.RepairCommand.register(dispatcher);
        com.zerog.bigbangessentials.items.commands.DisposeCommand.register(dispatcher);
        com.zerog.bigbangessentials.items.commands.PowertoolCommand.register(dispatcher);
        com.zerog.bigbangessentials.items.commands.EnchantCommand.register(dispatcher);
        com.zerog.bigbangessentials.items.commands.ClearInventoryCommand.register(dispatcher);
        com.zerog.bigbangessentials.items.commands.MiscItemCommands.register(dispatcher);
        ...
        com.zerog.bigbangessentials.economy.worth.WorthManager.getInstance().initialize();
        com.zerog.bigbangessentials.economy.worth.WorthCommand.register(dispatcher);
        com.zerog.bigbangessentials.economy.worth.SellCommand.register(dispatcher);
        ...
        com.zerog.bigbangessentials.util.commands.PlayerStateCommands.register(dispatcher);
        ...
        com.zerog.bigbangessentials.util.commands.ServerAdminCommands.register(dispatcher);
        ...
        com.zerog.bigbangessentials.util.commands.UtilityCommands.register(dispatcher);
        ...
        com.zerog.bigbangessentials.util.commands.ItemCustomisationCommands.register(dispatcher);
        ...
        com.zerog.bigbangessentials.util.commands.WorldInteractionCommands.register(dispatcher);
        ...
        com.zerog.bigbangessentials.util.commands.PlayerInfoCommands.register(dispatcher);
        ...
        com.zerog.bigbangessentials.commands.teleportation.WarpCommands.registerWarpInfoCommand(dispatcher);
        com.zerog.bigbangessentials.util.commands.ServerAdminCommands.registerWorldCommands(dispatcher);
        ...
        com.zerog.bigbangessentials.util.commands.FunCommands.register(dispatcher);

        // ========== VAULT API COMMANDS ==========
        registry.registerCommand("vault", "BigBangEssentials Vault API info and management");
        com.zerog.bigbangessentials.vault.command.VaultCommand.register(dispatcher);
        ...
        com.zerog.bigbangessentials.shop.commands.ShopCommand.register(dispatcher);
    }
        /*
     ...
     * }</pre>
     * 
     * @see com.zerog.bigbangessentials.api.PlaceholderAPI
     * @see com.zerog.bigbangessentials.api.DefaultPlaceholderExpansion
     */
    private void initializePlaceholderAPI() {
        LOGGER.debug("Initializing PlaceholderAPI system...");
        try {
            // Register the default BigBangEssentials placeholder expansion
            com.zerog.bigbangessentials.api.DefaultPlaceholderExpansion defaultExpansion = 
                new com.zerog.bigbangessentials.api.DefaultPlaceholderExpansion();
            
            LOGGER.debug("Created DefaultPlaceholderExpansion with {} placeholders", 
                defaultExpansion.getPlaceholders().size());
            
            boolean registered = com.zerog.bigbangessentials.api.PlaceholderAPI.registerExpansion(defaultExpansion);
            
            if (registered) {
                LOGGER.info("PlaceholderAPI initialized with {} default placeholders", 
                    defaultExpansion.getPlaceholders().size());
                LOGGER.debug("Available placeholders: {}", 
                    com.zerog.bigbangessentials.api.PlaceholderAPI.getRegisteredPlaceholders());
