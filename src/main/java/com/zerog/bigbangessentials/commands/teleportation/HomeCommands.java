package com.zerog.bigbangessentials.commands.teleportation;
...
public class HomeCommands {
    ...
    private static int executeHomeDefault(CommandContext<CommandSourceStack> context) {
        ...
        com.zerog.bigbangessentials.moderation.JailManager jailManager = com.zerog.bigbangessentials.moderation.JailManager.getInstance();
        if (config.isPreventJailEscapeEnabled() && jailManager.isPlayerJailed(player.getUUID())) {
            context.getSource().sendFailure(com.zerog.bigbangessentials.util.MessageUtil.error("commands.bigbangessentials.jail.prevent_escape"));
            return 0;
        }
    ...
    private static int executeRenameHome(CommandContext<CommandSourceStack> ctx,
        ...
        if (targetPlayerName != null) {
            ...
            if (target == null) {
                src.sendFailure(com.zerog.bigbangessentials.util.MessageUtil.error(
