...
public class ModRootCommand {
    ...
    private static int reloadConfiguration(CommandContext<CommandSourceStack> ctx) {
        ...
        try {
            ...
            totalCount++;
            try {
                com.zerog.bigbangessentials.config.ConfigManager.loadAll();
            ...
            totalCount++;
            try {
                com.zerog.bigbangessentials.kits.KitManager.getInstance().reload();
            ...
            totalCount++;
            try {
                com.zerog.bigbangessentials.teleportation.HomeManager.getInstance().reload();
            ...
            totalCount++;
            try {
                com.zerog.bigbangessentials.teleportation.Warp.WarpManager.getInstance().reload();
            ...
            totalCount++;
            try {
                com.zerog.bigbangessentials.teleportation.Spawn.SpawnManager.getInstance().reload();
            ...
            totalCount++;
            try {
                com.zerog.bigbangessentials.chat.AfkManager.getInstance().reload();
            ...
            totalCount++;
            try {
                com.zerog.bigbangessentials.moderation.JailManager.getInstance().reload();
