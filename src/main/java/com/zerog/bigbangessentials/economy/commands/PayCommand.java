package com.zerog.bigbangessentials.economy.commands;
...
public class PayCommand {
    ...
    private static long getPayCooldownMs() {
        return com.zerog.bigbangessentials.config.ConfigManager.getPayCooldownSeconds() * 1000L;
    }
        ...
        dispatcher.register(
            net.minecraft.commands.Commands.literal("pay")
                .requires(src -> src.hasPermission(2) || // Allow ops
                    (src.getPlayer() != null && com.zerog.bigbangessentials.api.permissions.PermissionAPI.hasPermission(src.getPlayer().getUUID(), "bigbangessentials.economy.pay")))
    ...
    private static int execute(CommandContext<CommandSourceStack> ctx) throws com.mojang.brigadier.exceptions.CommandSyntaxException {
        ...
        com.zerog.bigbangessentials.util.PermissionValidator.PermissionResult permResult = 
            com.zerog.bigbangessentials.util.PermissionValidator.validatePermission(ctx.getSource(), "bigbangessentials.economy.pay");
        ...
        com.zerog.bigbangessentials.util.InputValidator.ValidationResult nameValidation = 
            com.zerog.bigbangessentials.util.InputValidator.validatePlayerName(targetName);
        ...
        // Validate amount
        com.zerog.bigbangessentials.util.InputValidator.ValidationResult amountValidation = 
            com.zerog.bigbangessentials.util.InputValidator.validateEconomyAmount(amountRaw);
        ...
        if (onlineRecipient != null) {
            ...
            boolean canPayOffline = com.zerog.bigbangessentials.api.permissions.PermissionAPI
            ...
            Optional<UUID> uuidOpt = com.zerog.bigbangessentials.economy.EconomyPlayerUtil
        ...
        if (!com.zerog.bigbangessentials.economy.managers.PayToggleManager.getInstance()
        ...
        if (onlineRecipient != null
                && com.zerog.bigbangessentials.chat.IgnoreManager.isIgnoring(onlineRecipient, sender)) {
        ...
        // Calculate tax
        double taxPercent = com.zerog.bigbangessentials.config.ConfigManager.getEconomyTaxPercentage();
        ...
        boolean success = com.zerog.bigbangessentials.api.EconomyAPI.payPlayer(
        ...
        com.zerog.bigbangessentials.economy.managers.TransactionHistoryManager.getInstance()
        ...
        net.neoforged.neoforge.common.NeoForge.EVENT_BUS.post(
            new com.zerog.bigbangessentials.economy.events.EconomyTransactionEvent(
                com.zerog.bigbangessentials.economy.events.EconomyTransactionEvent.Type.PAY,
