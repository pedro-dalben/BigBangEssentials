...
import com.zerog.bigbangessentials.economy.EconomyTransactionLogger;
...
public class EcoCommand {
    ...
    private static void registerEcoCommand(CommandDispatcher<CommandSourceStack> dispatcher, String commandName) {
        dispatcher.register(
            net.minecraft.commands.Commands.literal(commandName)
                .requires(src -> src.hasPermission(2) || com.zerog.bigbangessentials.api.permissions.PermissionAPI.hasPermission(src.getPlayer() != null ? src.getPlayer().getUUID() : null, "bigbangessentials.economy.eco"))
    ...
    private static int ecoAdminAction(CommandContext<CommandSourceStack> ctx, String action) {
        ...
        com.zerog.bigbangessentials.util.PermissionValidator.PermissionResult permResult =
            com.zerog.bigbangessentials.util.PermissionValidator.validateAdminPermission(ctx.getSource(), "bigbangessentials.economy.eco");
        ...
        com.zerog.bigbangessentials.util.InputValidator.ValidationResult nameValidation =
            com.zerog.bigbangessentials.util.InputValidator.validatePlayerName(playerName);
        ...
        if ("reset".equals(action)) {
            BigDecimal startBal = BigDecimal.valueOf(
                com.zerog.bigbangessentials.config.ConfigManager.getEconomyStartingBalance());
