...
public class InputValidator {
    ...
    private static int getMaxCommandLength() {
        return com.zerog.bigbangessentials.config.ConfigManager.getInstance().getMaxCommandLength();
    }
    
    private static int getMaxReasonLength() {
        return com.zerog.bigbangessentials.config.ConfigManager.getInstance().getMaxReasonLength();
    }
    
    private static BigDecimal getMaxEconomyAmount() {
        return com.zerog.bigbangessentials.config.ConfigManager.getInstance().getMaxEconomyAmount();
    }
    
    private static BigDecimal getMinEconomyAmount() {
        return com.zerog.bigbangessentials.config.ConfigManager.getInstance().getMinEconomyAmount();
    }
    ...
    public static ValidationResult validatePlayerName(String playerName) {
        if (!com.zerog.bigbangessentials.config.ConfigManager.getInstance().isInputValidationEnabled()) {
    ...
    public static ValidationResult validateCommand(String command) {
        ...
        boolean allowUnsafeCommands = com.zerog.bigbangessentials.config.ConfigManager.getInstance().isUnsafeCommandsAllowed();
    ...
    public static ValidationResult validateEnchantmentLevel(int level, boolean allowUnsafeEnchants) {
        ...
        if (allowUnsafeEnchants) {
            int maxUnsafeLevel = com.zerog.bigbangessentials.config.ConfigManager.getInstance().getMaxUnsafeEnchantmentLevel();
