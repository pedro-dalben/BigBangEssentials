package com.zerog.bigbangessentials.items.handlers;

import com.zerog.bigbangessentials.items.commands.PowertoolCommand;
...
public class ItemInteractionHandler {
    ...
    private static void handlePowertool(PlayerInteractEvent event) {
        ...
        try {
            ...
            // Permission check
            if (!com.zerog.bigbangessentials.api.permissions.PermissionAPI
