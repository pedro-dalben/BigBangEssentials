...
// Server-side powertool assignments: player UUID -> item ID -> command
            ...
            Commands.literal(commandName)
                ...
                .then(Commands.literal("list")
                    .executes(ctx -> {
                        com.zerog.bigbangessentials.util.PermissionValidator.PermissionResult permResult =
                            com.zerog.bigbangessentials.util.PermissionValidator.validatePermission(ctx.getSource(), "bigbangessentials.item.powertool");
                ...
                .then(Commands.argument("command", StringArgumentType.greedyString())
                    .executes(ctx -> {
                        ...
                        // Validate command
                        com.zerog.bigbangessentials.util.InputValidator.ValidationResult cmdValidation = 
                            com.zerog.bigbangessentials.util.InputValidator.validateCommand(cmd);
    ...
    private static int executeTargetCommand(CommandSourceStack source, ServerPlayer executor, String command) {
        ...
        com.zerog.bigbangessentials.util.PermissionValidator.PermissionResult permResult = 
            com.zerog.bigbangessentials.util.PermissionValidator.validatePermission(source, "bigbangessentials.command.target");
        if (!permResult.hasPermission()) {
        ...
        // Validate command
        com.zerog.bigbangessentials.util.InputValidator.ValidationResult cmdValidation = 
            com.zerog.bigbangessentials.util.InputValidator.validateCommand(command);
        if (!cmdValidation.isValid()) {
