...
import com.zerog.bigbangessentials.webdashboard.security.AuthenticationManager;
import com.zerog.bigbangessentials.webdashboard.security.DiscordAuthConfig;
import com.zerog.bigbangessentials.webdashboard.security.DiscordAuthProvider;
import com.zerog.bigbangessentials.webdashboard.security.DiscordUser;
import com.zerog.bigbangessentials.webdashboard.security.Session;
import com.zerog.bigbangessentials.webdashboard.security.User;
...
public class AuthenticationHandler implements HttpHandler {
    ...
    private void handleLogin(HttpExchange exchange) throws IOException {
        ...
        if (com.zerog.bigbangessentials.config.ConfigManager.isDebugModeEnabled()) {
            if (session != null) {
    ...
    private Session handleMinecraftAuth(String minecraftUsername, String ipAddress, String userAgent) {
        try {
            ...
            net.minecraft.server.MinecraftServer server = com.zerog.bigbangessentials.webdashboard.DashboardAPI.getInstance().getServer();
            if (server == null) {
            ...
            if (playerUuid == null) {
                com.zerog.bigbangessentials.permissions.PermissionManager permManager =
                    com.zerog.bigbangessentials.api.permissions.PermissionAPI.getManager();

                if (permManager != null) {
                    // Check if we have a user with this username in our system
                    for (com.zerog.bigbangessentials.permissions.PermissionUser permUser : permManager.getUsers()) {
            ...
            if (playerUuid == null && com.zerog.bigbangessentials.api.permissions.PermissionAPI.isUsingExternal()) {
                try {
                    com.zerog.bigbangessentials.permissions.ExternalPermissionAdapter adapter =
                        com.zerog.bigbangessentials.api.permissions.PermissionAPI.getExternalAdapter();

                    if (adapter instanceof com.zerog.bigbangessentials.permissions.LuckPermsAdapter) {
            ...
            boolean hasAccess = com.zerog.bigbangessentials.api.permissions.PermissionAPI.hasPermission(
