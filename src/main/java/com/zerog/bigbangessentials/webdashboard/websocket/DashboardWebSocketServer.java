package com.zerog.bigbangessentials.webdashboard.websocket;
 ...
 * Lifecycle is managed by {@link com.zerog.bigbangessentials.webdashboard.DashboardLifecycleManager}.
 */
...
public class DashboardWebSocketServer extends WebSocketServer {
    ...
    private void handleAuthenticate(WebSocket conn, JsonObject msg) {
        ...
        com.zerog.bigbangessentials.webdashboard.security.AuthenticationManager authManager =
            com.zerog.bigbangessentials.webdashboard.security.AuthenticationManager.getInstance();
        com.zerog.bigbangessentials.webdashboard.security.Session session =
