            ...
            .then(Commands.argument("target", EntityArgument.player())
                .then(Commands.argument("message", StringArgumentType.greedyString())
                    .executes(ctx -> {
                        ...
                        if (!com.zerog.bigbangessentials.config.ConfigManager.getInstance().isCommandEnabled("msg")) {
                        ...
                        boolean hasPermission = com.zerog.bigbangessentials.api.permissions.PermissionAPI.hasPermission(sender.getUUID(), "bigbangessentials.chat.msg");
                        ...
                        boolean isMuted = com.zerog.bigbangessentials.chat.MuteManager.isMuted(sender);
