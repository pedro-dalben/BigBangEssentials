    ...
    private static void registerSocialSpyCommand(CommandDispatcher<CommandSourceStack> dispatcher, String commandName) {
        dispatcher.register(Commands.literal(commandName)
            .executes(ctx -> {
                ...
                if (!com.zerog.bigbangessentials.config.ConfigManager.getInstance().isCommandEnabled("socialspy")) {
                    ctx.getSource().sendFailure(MessageUtil.error("commands.bigbangessentials.socialspy.disabled"));
                    return 0;
                }
                ...
                if (!com.zerog.bigbangessentials.api.permissions.PermissionAPI.hasPermission(sender.getUUID(), "bigbangessentials.chat.socialspy")) {
                ...
                com.zerog.bigbangessentials.chat.SocialSpyManager.toggleSocialSpy(sender);
                boolean isNowEnabled = com.zerog.bigbangessentials.chat.SocialSpyManager.hasSocialSpy(sender);
