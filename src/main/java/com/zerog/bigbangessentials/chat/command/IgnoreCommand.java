        ...
        dispatcher.register(Commands.literal(commandName)
            .then(Commands.argument("target", EntityArgument.player())
                .executes(ctx -> {
                    ...
                    if (!com.zerog.bigbangessentials.config.ConfigManager.getInstance().isCommandEnabled("ignore")) {
                        source.sendFailure(MessageUtil.error("commands.bigbangessentials.ignore.disabled"));
                        return 0;
                    }
                    ...
                    if (com.zerog.bigbangessentials.api.permissions.PermissionAPI.hasPermission(targetPlayer.getUUID(), "bigbangessentials.chat.ignore.exempt")) {
                        source.sendFailure(MessageUtil.error("commands.bigbangessentials.ignore.exempt", targetName));
                        return 0;
                    }
                    
                    com.zerog.bigbangessentials.chat.IgnoreManager.ignore(sender, targetName);
