        ...
        dispatcher.register(Commands.literal(commandName)
            .then(Commands.argument("message", StringArgumentType.greedyString())
                .executes(ctx -> {
                    ...
                    ServerPlayer target = com.zerog.bigbangessentials.chat.LastMessageManager.getLastMessager(sender);
                    ...
                    if (!com.zerog.bigbangessentials.config.ConfigManager.getInstance().isCommandEnabled("reply")) {
                        source.sendFailure(MessageUtil.error("commands.bigbangessentials.reply.disabled"));
                        return 0;
                    }
                    
                    // Legacy check for backwards compatibility
                    com.zerog.bigbangessentials.chat.ChatManager chatManager = com.zerog.bigbangessentials.api.ChatAPI.getChatManager();
                    ...
                    if (!com.zerog.bigbangessentials.api.permissions.PermissionAPI.hasPermission(sender.getUUID(), "bigbangessentials.chat.reply")) {
                    ...
                    String resolvedToMessage = com.zerog.bigbangessentials.api.PlaceholderAPI.setPlaceholders(target, toMessage);
                    String resolvedFromMessage = com.zerog.bigbangessentials.api.PlaceholderAPI.setPlaceholders(sender, fromMessage);
                    ...
                    com.zerog.bigbangessentials.chat.LastMessageManager.setLastMessager(target, sender);
                    
                    com.zerog.bigbangessentials.api.ChatAPI.broadcastSocialSpy(sender, target, message);
                    
                    // --- External plugin integration ---
                    com.zerog.bigbangessentials.integrations.ChatIntegrationManager.broadcastPrivateMessage(sender, target, message);
