...
public class ChatHandler {
    ...
    public static void onServerChat(ServerChatEvent event) {
        try {
            ...
            com.google.gson.JsonObject mainConfig = com.zerog.bigbangessentials.config.ConfigManager.getInstance().getConfig(com.zerog.bigbangessentials.config.ConfigManager.MAIN_CONFIG);
            ...
            if (com.zerog.bigbangessentials.config.ConfigManager.isChatFormattingEnabled()) {
                ...
                if (playerList != null) {
                    if (hasRadius) {
                        ...
                        for (ServerPlayer target : playerList.getPlayers()) {
                            ...
                            if (requiredPermission != null && !com.zerog.bigbangessentials.api.permissions.PermissionAPI.hasPermission(target.getUUID(), requiredPermission)) {
                                continue;
                            }
                        ...
                        for (ServerPlayer target : playerList.getPlayers()) {
                            if (com.zerog.bigbangessentials.api.permissions.PermissionAPI.hasPermission(target.getUUID(), requiredPermission)) {
                                target.sendSystemMessage(formattedMessage);
                            }
                        }
                ...
                try {
                    ...
                    if (requiredPermission != null && !com.zerog.bigbangessentials.api.permissions.PermissionAPI.hasPermission(player.getUUID(), requiredPermission)) {
                    ...
                    if (discordEnabled && permissionPassed) {
                        ...
                        com.zerog.bigbangessentials.integrations.ChatIntegrationManager.broadcastPlayerChat(
    ...
    private static boolean isConsoleLoggingEnabled() {
        try {
            com.google.gson.JsonObject config = com.zerog.bigbangessentials.config.ConfigManager.getInstance()
