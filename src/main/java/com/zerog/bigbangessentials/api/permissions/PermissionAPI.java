...
import com.zerog.bigbangessentials.permissions.ExternalPermissionAdapter;
...
public class PermissionAPI {
    ...
    public static boolean hasPermission(UUID uuid, String permission) {
        ...
        if (com.zerog.bigbangessentials.config.ConfigManager.getInstance().isOpsBypassPermissionsEnabled()) {
