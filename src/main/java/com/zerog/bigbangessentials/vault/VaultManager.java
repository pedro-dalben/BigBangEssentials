package com.zerog.bigbangessentials.vault;

import com.zerog.bigbangessentials.vault.api.VaultServiceRegistry;
import com.zerog.bigbangessentials.vault.api.VaultServiceRegistry.ServicePriority;
import com.zerog.bigbangessentials.vault.impl.BigBangEssentialsChat;
import com.zerog.bigbangessentials.vault.impl.BigBangEssentialsEconomy;
import com.zerog.bigbangessentials.vault.impl.BigBangEssentialsPermission;
...
public class VaultManager {
    ...
    public static java.util.Optional<com.zerog.bigbangessentials.vault.api.VaultEconomy> getEconomy() {
        return VaultServiceRegistry.getInstance().getEconomy();
    }

    /** Convenience accessor — permission. */
    public static java.util.Optional<com.zerog.bigbangessentials.vault.api.VaultPermission> getPermission() {
        return VaultServiceRegistry.getInstance().getPermission();
    }

    /** Convenience accessor — chat metadata. */
    public static java.util.Optional<com.zerog.bigbangessentials.vault.api.VaultChat> getChat() {
