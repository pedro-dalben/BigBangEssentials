package com.zerog.bigbangessentials.vault.command;

import com.mojang.brigadier.CommandDispatcher;
import com.mojang.brigadier.arguments.StringArgumentType;
import com.zerog.bigbangessentials.vault.api.VaultEconomy;
    ...
    public static void register(CommandDispatcher<CommandSourceStack> dispatcher) {
        dispatcher.register(Commands.literal("vault")
            .requires(src -> src.hasPermission(3) ||
                com.zerog.bigbangessentials.api.permissions.PermissionAPI.hasPermission(
