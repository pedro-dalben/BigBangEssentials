...
public class DirectTeleportManager {
    ...
    public boolean teleportToOfflinePlayer(ServerPlayer executor, String playerName) {
        try {
            ...
            com.zerog.bigbangessentials.BigBangEssentialsManager manager = com.zerog.bigbangessentials.BigBangEssentialsManager.getInstance();
            com.zerog.bigbangessentials.BigBangEssentialsManager.PlayerData playerData = manager.getPlayerData(profile.getId());
            ...
            // Save current location for /back command
            com.zerog.bigbangessentials.teleportation.Misc.MiscTeleportManager.getInstance().saveBackLocation(executor);
