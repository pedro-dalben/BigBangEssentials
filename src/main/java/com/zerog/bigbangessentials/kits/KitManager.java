package com.zerog.bigbangessentials.kits;
...
public class KitManager {
    ...
    private final File playerDataFile = com.zerog.bigbangessentials.util.ResourceUtil.getDataFile("kit_player_data.json");
    ...
    private void loadKits() {
        try {
            File kitsFile = com.zerog.bigbangessentials.util.ResourceUtil.getConfigFile("kits.json");
                            ...
                            for (JsonElement element : kitsArray) {
                                if (element.isJsonObject()) {
                                    try {
                                        ...
                                        try {
                                            com.zerog.bigbangessentials.api.permissions.PermissionRegistry.getInstance()
    ...
    public KitUsageResult canUseKit(ServerPlayer player, String kitName) {
        ...
        if (com.zerog.bigbangessentials.config.ConfigManager.getInstance().isAllowKitOverrideEnabled() &&
            com.zerog.bigbangessentials.api.permissions.PermissionAPI.hasPermission(player.getUUID(), "bigbangessentials.kits.override")) {
        ...
        int maxKits = com.zerog.bigbangessentials.config.ConfigManager.getInstance().getMaxKitsPerPlayer();
    ...
    public KitUsageResult giveKit(ServerPlayer player, String kitName) {
        ...
        try {
            ...
            boolean autoEquip = com.zerog.bigbangessentials.config.ConfigManager.isKitAutoEquipEnabled();
            ...
            for (ItemStack item : otherItems) {
                ...
                com.zerog.bigbangessentials.items.ItemSpawnHelper.SpawnResult spawnResult =
                    com.zerog.bigbangessentials.items.ItemSpawnHelper.canSpawnItem(player, item);
            ...
            if (com.zerog.bigbangessentials.config.ConfigManager.isLogKitUsageEnabled()) {
    ...
    private boolean hasCooldownExemption(ServerPlayer player, String kitName) {
        ...
        if (com.zerog.bigbangessentials.config.ConfigManager.getInstance().isAllowKitOverrideEnabled()) {
            if (com.zerog.bigbangessentials.api.permissions.PermissionAPI.hasPermission(playerId, "bigbangessentials.kits.override")) {
                return true;
            }
        }
        // Check global cooldown exemption
        if (com.zerog.bigbangessentials.api.permissions.PermissionAPI.hasPermission(playerId, "bigbangessentials.kits.nocooldown")) {
            return true;
        }
        
        // Check per-kit cooldown exemption
        String kitNocooldownPermission = "bigbangessentials.kits." + kitName.toLowerCase() + ".nocooldown";
        if (com.zerog.bigbangessentials.api.permissions.PermissionAPI.hasPermission(playerId, kitNocooldownPermission)) {
            return true;
        }
