...
public class PermissionSystem {
    ...
    public static void initialize() {
        ...
        try {
            ...
            com.zerog.bigbangessentials.api.permissions.PermissionValidator.ValidationResult validation =
                com.zerog.bigbangessentials.api.permissions.PermissionValidator.validate(manager);
