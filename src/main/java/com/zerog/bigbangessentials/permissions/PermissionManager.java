...
public class PermissionManager {
    ...
    private long getCacheTtlMs() {
        int minutes = com.zerog.bigbangessentials.config.ConfigManager.getInstance().getPermissionCacheExpiryMinutes();
    ...
    String configDefault = com.zerog.bigbangessentials.config.ConfigManager.getInstance().getDefaultGroup();
    ...
    public boolean hasPermission(UUID uuid, String permission) {
        ...
        boolean cacheEnabled = com.zerog.bigbangessentials.config.ConfigManager.getInstance().isPermissionCacheEnabled();
