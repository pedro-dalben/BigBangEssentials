package com.pedrodalben.bigbangessentials.resourcepacks;
    ...
    public void sendPackToPlayer(ServerPlayer player, ResourcePack pack) {
        ...
        try {
            ...
            ClientboundResourcePackPacket packet = new ClientboundResourcePackPacket(
                ...
                pack.getFileHash(),
                required,
                net.minecraft.network.chat.Component.literal(pack.getDescription() != null ? pack.getDescription() : pack.getName())
            );
