...
public class AfkActivityHandler {
        ...
        public void recordActivity(String activityType) {
            ...
            if (lastTime != null && (now - lastTime) < REPETITIVE_TIMEFRAME) {
                ...
                if (count > REPETITIVE_ACTION_THRESHOLD) {
                    suspiciousScore += 10;
                    com.pedrodalben.bigbangessentials.util.DebugLogger.log(LOGGER, "Detected repetitive {} activity: {} times", activityType, count);
                }
            } else {
    ...
    private static void recordActivity(ServerPlayer player, String activityType) {
        ...
        if (!pattern.isSuspicious()) {
            ...
            com.pedrodalben.bigbangessentials.util.DebugLogger.log(LOGGER, "Activity tracked for {}: {} (score: {})",
            ...
            com.pedrodalben.bigbangessentials.util.DebugLogger.log(LOGGER, "Suspicious activity pattern detected for {}: {} (score: {})",
                player.getName().getString(), activityType, pattern.getSuspiciousScore());
        }
    }
    ...
    public static void onPlayerLogout(PlayerEvent.PlayerLoggedOutEvent event) {
        if (event.getEntity() instanceof ServerPlayer player) {
            ...
            com.pedrodalben.bigbangessentials.util.DebugLogger.log(LOGGER, "AFK tracking cleanup for: {}", player.getName().getString());
        }
    }
    ...
    public static void onPlayerLogin(PlayerEvent.PlayerLoggedInEvent event) {
        if (event.getEntity() instanceof ServerPlayer player) {
            ...
            com.pedrodalben.bigbangessentials.util.DebugLogger.log(LOGGER, "AFK tracking initialized for: {}", player.getName().getString());
        }
    }
