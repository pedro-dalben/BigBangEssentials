...
public class PlayerInfoCommands {
    ...
    private static int executeMsgToggle(CommandContext<CommandSourceStack> ctx, String targetName, Boolean block) {
        ...
        boolean currentMsgToggle = com.pedrodalben.bigbangessentials.chat.MsgToggleManager.isMsgToggled(target);
        if (currentMsgToggle != newBlocked) {
            com.pedrodalben.bigbangessentials.chat.MsgToggleManager.toggleMsg(target);
        }
