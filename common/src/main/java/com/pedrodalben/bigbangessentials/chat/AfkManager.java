...
public class AfkManager {
    ...
    // Data persistence
    private final File afkDataFile = new File(com.pedrodalben.bigbangessentials.util.ResourceUtil.DATA_DIR + "afk_data.json");
    ...
    private void startAutoSaveTask() {
        ...
        afkCheckExecutor.scheduleAtFixedRate(() -> {
            if (autoSave) {
                try {
                    saveAfkData();
                    com.pedrodalben.bigbangessentials.util.DebugLogger.log(LOGGER, "AFK data auto-saved");
                } catch (Exception e) {
