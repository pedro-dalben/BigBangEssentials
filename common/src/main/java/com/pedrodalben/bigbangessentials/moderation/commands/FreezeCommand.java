...
public class FreezeCommand {
    ...
    public static void register(CommandDispatcher<CommandSourceStack> dispatcher) {
        ...
        dispatcher.register(Commands.literal("freeze")
            ...
            .then(Commands.argument("player", StringArgumentType.word())
                ...
                .executes(ctx -> executeFreeze(ctx, 
                    ...
                    com.pedrodalben.bigbangessentials.config.ConfigManager.getDefaultFreezeReason()))
        ...
        dispatcher.register(Commands.literal("freezeall")
            ...
            .executes(ctx -> executeFreezeAll(ctx, com.pedrodalben.bigbangessentials.config.ConfigManager.getDefaultFreezeReason()))
            .then(Commands.argument("reason", StringArgumentType.greedyString())
    ...
    private static int executeFreeze(CommandContext<CommandSourceStack> ctx, String playerName, String reason) {
        ...
        try {
            ...
            int maxReasonLen = com.pedrodalben.bigbangessentials.config.ConfigManager.getMaxFreezeReasonLength();
