...
public class PermissionsCommand {
    ...
    public static void register(CommandDispatcher<CommandSourceStack> dispatcher) {
        ...
        boolean pexEnabled = com.pedrodalben.bigbangessentials.config.ConfigManager.getInstance().isCommandEnabled("pex");
        boolean permissionsEnabled = com.pedrodalben.bigbangessentials.config.ConfigManager.getInstance().isCommandEnabled("permissions");
                            ...
                            .suggests((ctx, builder) -> {
                                ...
                                try {
                                    java.util.List<String> permissions = 
                                        com.pedrodalben.bigbangessentials.api.permissions.external.ExternalPermissionProvider.getAllBigBangEssentialsPermissions();
    ...
    private static int reload(CommandContext<CommandSourceStack> ctx) {
        ...
        try {
            com.pedrodalben.bigbangessentials.permissions.PermissionSystem.reload();
