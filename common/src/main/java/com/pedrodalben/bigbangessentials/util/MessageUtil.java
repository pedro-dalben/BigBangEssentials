...
public class MessageUtil {
    ...
    public static void syncDebugModeFromConfig() {
        debugMode = com.pedrodalben.bigbangessentials.config.ConfigManager.isDebugModeEnabled();
    ...
    private static final int CURRENT_LANG_VERSION = 201;
    ...
    public static Component coloredText(String text) {
        if (!com.pedrodalben.bigbangessentials.config.ConfigManager.isColorCodesEnabled()) {
