...
public class JobsEvents {
    ...
    public static class JobJoinEvent extends JobEvent implements ICancellableEvent {
        public JobJoinEvent(UUID playerUuid, String jobId) {
            super(playerUuid, jobId);
        }
    }

    public static class JobLeaveEvent extends JobEvent implements ICancellableEvent {
        public JobLeaveEvent(UUID playerUuid, String jobId) {
            super(playerUuid, jobId);
        }
    }

    public static class JobExperienceGainEvent extends JobEvent implements ICancellableEvent {
    ...
    public static class JobRewardCalculateEvent extends JobEvent implements ICancellableEvent {
    ...
    public static class JobSkillUnlockEvent extends JobEvent implements ICancellableEvent {
