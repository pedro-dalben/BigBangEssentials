...
public class DiscordPermissionSync {
    ...
    public SyncResult syncPlayerPermissions(ServerPlayer player) {
        ...
        try {
            ...
            com.pedrodalben.bigbangessentials.permissions.PermissionManager permManager = com.pedrodalben.bigbangessentials.api.permissions.PermissionAPI.getManager();
            ...
            for (String role : discordUser.getDiscordRoles()) {
                ...
                if (permissionGroup != null && !permissionGroup.isEmpty()) {
                    ...
                    com.pedrodalben.bigbangessentials.permissions.PermissionUser user = permManager.getUser(player.getUUID());
                    if (user != null) {
                        ...
                        try {
                            com.pedrodalben.bigbangessentials.permissions.PermissionStorage.save(permManager);
