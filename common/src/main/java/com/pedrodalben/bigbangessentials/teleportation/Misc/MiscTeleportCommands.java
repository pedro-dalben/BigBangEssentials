package com.pedrodalben.bigbangessentials.teleportation.Misc;
...
public class MiscTeleportCommands {
    ...
    private static int executeTpAuto(CommandContext<CommandSourceStack> ctx, String targetName, Boolean enable) {
        ...
        if (newState && !com.pedrodalben.bigbangessentials.util.commands.ItemCustomisationCommands.isTpToggleAllowed(target.getUUID())) {
